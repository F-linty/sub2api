<template>
  <div class="card">
    <div class="border-b border-gray-100 px-5 py-3 dark:border-dark-700">
      <h2 class="text-sm font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">{{ t('dashboard.quickActions') }}</h2>
    </div>
    <div class="divide-y divide-gray-100 dark:divide-dark-700">
      <button @click="router.push('/keys')" class="group flex w-full items-center gap-3 px-5 py-4 text-left transition-colors hover:bg-gray-50 dark:hover:bg-dark-700/50">
        ...
        <Icon
          name="chevronRight"
          size="md"
          class="text-gray-400 transition-colors group-hover:text-gray-700 dark:text-dark-500 dark:group-hover:text-gray-300"
        />
      </button>

      <button @click="router.push('/usage')" class="group flex w-full items-center gap-3 px-5 py-4 text-left transition-colors hover:bg-gray-50 dark:hover:bg-dark-700/50">
