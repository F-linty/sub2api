    ...
    <div v-if="!isSimple" class="metric-card">
      <div class="metric-row">
        ...
        <div>
          ...
          <p class="metric-value text-primary-600 dark:text-primary-300">${{ formatBalance(balance) }}</p>
          <p class="metric-note">{{ t('common.available') }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="metric-card">
      <div class="metric-row">
        ...
        <div>
          ...
          <p class="metric-note">{{ stats?.active_api_keys || 0 }} {{ t('common.active') }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="metric-card">
      <div class="metric-row">
        ...
        <div>
          ...
          <p class="metric-note">{{ t('common.total') }}: {{ formatNumber(stats?.total_requests || 0) }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="metric-card">
      <div class="metric-row">
        ...
        <div>
          ...
          <p class="metric-note">{{ t('dashboard.input') }}: {{ formatTokens(stats?.today_input_tokens || 0) }} / {{ t('dashboard.output') }}: {{ formatTokens(stats?.today_output_tokens || 0) }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="metric-card">
      <div class="metric-row">
        ...
        <div>
          ...
          <p class="metric-note">{{ t('dashboard.input') }}: {{ formatTokens(stats?.total_input_tokens || 0) }} / {{ t('dashboard.output') }}: {{ formatTokens(stats?.total_output_tokens || 0) }}</p>
        </div>
      </div>
    </div>
