    ...
    >
      <div class="px-6 py-6 md:px-8">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start">
          <div
            class="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-lg border border-gray-200 bg-gray-950 text-2xl font-semibold text-white dark:border-dark-600 dark:bg-white dark:text-gray-950"
          >
            <img
              v-if="avatarUrl"
              :src="avatarUrl"
          ...
          <div class="min-w-0 flex-1 space-y-5">
              ...
              <div class="space-y-1">
                ...
                >
                  <span
                    ...
                    :key="hint.key"
                    class="inline-flex items-center gap-1 rounded-md border border-gray-200 bg-white px-2.5 py-1 dark:border-dark-600 dark:bg-dark-900/70"
                  >
            ...
            <div class="grid gap-3 sm:grid-cols-3">
              <div
                ...
                class="rounded-lg border border-gray-200 bg-white px-4 py-3 dark:border-dark-700 dark:bg-dark-900/60"
              >
                <p class="metric-label">
                  {{ t('profile.accountBalance') }}
                </p>
                <p class="mt-1 text-lg font-semibold tabular-nums text-primary-600 dark:text-primary-300">
