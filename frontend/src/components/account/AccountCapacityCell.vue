...
const concurrencyClass = computed(() => {
  ...
  if (current >= max) return 'bg-[#fbe7df] text-[#873628] dark:bg-red-500/20 dark:text-red-200'
  if (current > 0) return 'bg-[#fff4dc] text-[#8a5a00] dark:bg-amber-500/20 dark:text-amber-200'
  return 'bg-[#f3f1ee] text-[#5f5b57] dark:bg-gray-800 dark:text-gray-400'
})
...
const windowCostClass = computed(() => {
  ...
  if (current >= limit + reserve) return 'bg-[#fbe7df] text-[#873628] dark:bg-red-500/20 dark:text-red-200'
  if (current >= limit) return 'bg-[#fff4dc] text-[#8a5a00] dark:bg-amber-500/20 dark:text-amber-200'
  if (current >= limit * 0.8) return 'bg-[#fff4dc] text-[#8a5a00] dark:bg-amber-500/20 dark:text-amber-200'
...
const sessionLimitClass = computed(() => {
  ...
  if (current >= max) return 'bg-[#fbe7df] text-[#873628] dark:bg-red-500/20 dark:text-red-200'
  if (current >= max * 0.8) return 'bg-[#fff4dc] text-[#8a5a00] dark:bg-amber-500/20 dark:text-amber-200'
  return 'bg-[#eaf7f1] text-[#0f8f6a] dark:bg-emerald-500/20 dark:text-emerald-200'
})
...
const rpmClass = computed(() => {
  ...
  if (rpmStrategy.value === 'tiered') {
    if (current >= base + buffer) return 'bg-[#fbe7df] text-[#873628] dark:bg-red-500/20 dark:text-red-200'
    if (current >= base) return 'bg-[#fff4dc] text-[#8a5a00] dark:bg-amber-500/20 dark:text-amber-200'
  } else {
    if (current >= base) return 'bg-[#fff4dc] text-[#8a5a00] dark:bg-amber-500/20 dark:text-amber-200'
  }
  if (current >= base * 0.8) return 'bg-[#fff4dc] text-[#8a5a00] dark:bg-amber-500/20 dark:text-amber-200'
  return 'bg-[#eaf7f1] text-[#0f8f6a] dark:bg-emerald-500/20 dark:text-emerald-200'
})
